...
public class EmpresaController {
    ...
    public EmpresaController(PlacaService placaService, CategoriaService categoriaService) {
...
// Lista completa del catálogo
    ...
    public String catalogo(
        ...
        List<Placa> empresas = listaCompleta.stream()
                .filter(p -> p.getCategoria() != null && "Placas para Empresas".equalsIgnoreCase(p.getCategoria().getNombre()))
                .toList();
